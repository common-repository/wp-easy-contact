...
?>
			<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e('Title', 'emd-plugins'); ?></label><br />
			<input class="widefat" type="text" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($instance['title']); ?>" />
			</p>
		<?php if($this->type != 'integration'){			?>
			<p>
			<label for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php printf(__('Max number of %s to show', 'emd-plugins') , $this->class_label); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('pagination')); ?>"><?php printf(__('Enable pagination', 'emd-plugins') , $this->class_label); ?></label>
			</p>
			<p class="emd-paginate-show" <?php echo esc_attr($paginate_style); ?>>
			<label for="<?php echo esc_attr($this->get_field_id('pagination_size')); ?>"><?php echo __('Pagination size', 'emd-plugins'); ?></label>
			...
			<p class="emd-paginate-show" <?php echo esc_attr($paginate_style); ?>>
			<label for="<?php echo esc_attr($this->get_field_id('count_per_page')); ?>"><?php printf(__('Number of %s to show per pagination', 'emd-plugins') , $this->class_label); ?></label>
